"""
LucidControl Digital Output USB Module DO16 implementation
@author: Klaus Ummenhofer
"""

from lucidIo.LucidControlDO import LucidControlDO

class LucidControlDO16(LucidControlDO):
    """LucidControl Digital Output USB Module DO16 class
    """
    ...
    def getIoGroup(self, channels, values):
        ...
        Args:
            ...
            values: Digital values.
                A tuple with 16 digital value objects. The function fills
    ...
    def setIoGroup(self, channels, values):
        ...
        Args:
            channels: Tuple with 16 boolean values (one for each channel).
                ...
                true.
            values: Digital values.
                A tuple with 16 digital value objects. The values of the
