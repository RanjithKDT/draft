...
LucidControl Analog Output USB Module AO8 implementation
...
class LucidControlAO8(LucidControlAO):
    """""LucidControl Analog Output USB Module AO8 class
    """
    ...
    def setParamModeDefault(self, channel, persistent):
        ...
        Args:
            channel: IO channel number. Must be the range 0 ... 7
