...
LucidControl Digital Input USB Module DI16 implementation
...
class LucidControlDI16(LucidControlDI):
    """LucidControl Digital Input USB Module DI16 class
    """
    ...
    def getIo(self, channel, value):
        ...
        Args:
            channel: IO channel number. Must be in the range 0 ... 15
    ...
    def getIoGroup(self, channels, values):
        ...
        Args:
            channels: Tuple with 16 boolean values (one for each channel).
                A channel is only read if the corresponding channel is
                true.
            values: Digital values.
                A tuple with 16 digital value objects of type ValueDI1 or
    ...
    def getParamFlagAddCounter(self, channel, addCounter):
        ...
        Raises:
            ...
            ValueError: Channel value is out of range
        """
        return super().getParamFlagAddCounter(channel, addCounter)
    ...
    def setParamFlagAddCounter(self, channel, persistent, addCounter):
        ...
        Raises:
            ...
            ValueError: Channel value is out of range
        """
        return super().setParamFlagAddCounter(channel, persistent, addCounter)
    ...
    def getParamFlagResetCounterRead(self, channel, resetCounterRead):
        ...
        Raises:
            ...
            ValueError: Channel value is out of range
        """
        return super().getParamFlagResetCounterRead(channel, resetCounterRead)
    ...
    def setParamFlagResetCounterRead(self, channel, persistent,
        ...
        Raises:
            ...
            ValueError: Channel value is out of range
        """
        return super().setParamFlagResetCounterRead(channel, persistent, resetCounterRead)
    ...
    def getParamScanTime(self, channel, scanTime):
        ...
        Raises:
            ...
            ValueError: Channel value is out of range
        """
        return super().getParamScanTime(channel, scanTime)
    ...
    def setParamScanTimeDefault(self, channel, persistent):
        ...
        Raises:
            ...
            ValueError: Channel value is out of range
        """
        return super().setParamScanTimeDefault(channel, persistent)
    ...
    def setParamScanTime(self, channel, persistent, scanTime):
        ...
        """
        return super().setParamScanTime(channel, persistent, scanTime)
    ...
    def getParamCountTime(self, channel, countTime):
        ...
        Raises:
            ...
            ValueError: Channel value is out of range
        """
        return super().getParamCountTime(channel, countTime)        
    ...
    def setParamCountTimeDefault(self, channel, persistent):
        ...
        Raises:
            ...
            ValueError: Channel value is out of range
        """
        return super().setParamCountTimeDefault(channel, persistent)
    ...
    def setParamCountTime(self, channel, persistent, countTime):
        ...
        Raises:
            ...
            ValueError: Channel or cycleTime value is out of range
        """
        return super().setParamCountTime(channel, persistent, countTime)
    ...
    def __init__(self, portName):
        ...
        """
        LucidControlDI.__init__(self, portName)
        self.nrOfChannels = 16
