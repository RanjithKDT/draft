...
LucidControl Analog Input USB Module AI8 implementation
@author: Klaus Ummenhofer
'''

from  lucidIo.LucidControlAI import LucidControlAI
import lucidIo.IoReturn

    
class LucidControlAI8(LucidControlAI):
    """""LucidControl Analog Input USB Module AI8 class
    """
