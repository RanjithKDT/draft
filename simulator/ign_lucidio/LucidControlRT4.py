...
class LucidControlRT4(LucidControlRT):
    ...
    def getParamScanInterval(self, channel, scanInterval):
        ...
        Raises:
            ...
            ValueError: Channel value is out of range
        """  
        return super().getParamScanInterval(channel, scanInterval)      
    ...
    def setParamScanIntervalDefault(self, channel, persistent):
        ...
        Raises:
            ...
            ValueError: Channel value is out of range
        """
        return super().setParamScanIntervalDefault(channel, persistent)
    ...
    def setParamScanInterval(self, channel, persistent, scanInterval):
        ...
        """
        return super().setParamScanInterval(channel, persistent, scanInterval)
    ...
    def getParamSetupTime(self, channel, setupTime):
        ...
        Raises:
            ...
            ValueError: Channel value is out of range
        """   
        return super().getParamSetupTime(channel, setupTime)     
    ...
    def setParamSetupTimeDefault(self, channel, persistent):
        ...
        Raises:
            ...
            ValueError: Channel value is out of range
        """
        return super().setParamSetupTimeDefault(channel, persistent)
    ...
    def setParamSetupTime(self, channel, persistent, setupTime):
        ...
        """
        return super().setParamSetupTime(channel, persistent, setupTime)
    ...
    def __init__(self, portName):
        ...
        """
        LucidControlRT.__init__(self, portName)
        self.nrOfChannels = 4
