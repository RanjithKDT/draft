...
class _DeviceClass(object):
    ...
    DI16            = (0x0030, "DIGITAL INPUT 16 CHANNELS")
    ...
    DO6             = (0x1020,  "DIGITAL OUTPUTS 6 CHANNELS")
    DO16            = (0x1030,  "DIGITAL OUTPUTS 16 CHANNELS")
...
class LucidControl(object):
    ...
    def getDeviceClassName(self):
        if (self.id.validData == True):
            ...
            if (self.id.deviceClass == _DeviceClass.DI16[0]):
                return _DeviceClass.DI16[1]
            if (self.id.deviceClass == _DeviceClass.AI4[0]):
                return _DeviceClass.AI4[1]
            if (self.id.deviceClass == _DeviceClass.AI8[0]):
                return _DeviceClass.AI8[1]
            ...
            if (self.id.deviceClass == _DeviceClass.DO6[0]):
                return _DeviceClass.DO6[1]
            if (self.id.deviceClass == _DeviceClass.DO8[0]):
                return _DeviceClass.DO8[1]
            if (self.id.deviceClass == _DeviceClass.DO16[0]):
                return _DeviceClass.DO16[1]
            if (self.id.deviceClass == _DeviceClass.AO4[0]):
                return _DeviceClass.AO4[1]
            if (self.id.deviceClass == _DeviceClass.AO8[0]):
                return _DeviceClass.AO8[1]
            if (self.id.deviceClass == _DeviceClass.DI4DO4[0]):
                return _DeviceClass.DI4DO4[1]
            else:
